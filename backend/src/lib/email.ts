...
function html(env: EmailEnv, o: EmailOptions) {
  ...
  return `<!doctype html><html lang="fa" dir="rtl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head><body style="margin:0;background:#020100;color:#fff;font-family:Vazirmatn,IRANSansX,Tahoma,Arial,sans-serif;direction:rtl;text-align:right"><table width="100%" cellpadding="0" cellspacing="0" style="padding:36px 12px;background:radial-gradient(circle at 85% 0%,rgba(214,173,82,.26),transparent 34%),radial-gradient(circle at 0% 90%,rgba(255,240,189,.10),transparent 30%),linear-gradient(180deg,#020100,#080502 58%,#020100)"><tr><td align="center"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:720px;border:1px solid rgba(214,173,82,.30);border-radius:36px;overflow:hidden;background:linear-gradient(145deg,rgba(255,255,255,.075),rgba(255,255,255,.018));box-shadow:0 34px 120px rgba(214,173,82,.14)"><tr><td style="padding:34px;background:linear-gradient(135deg,rgba(214,173,82,.32),rgba(0,0,0,.88))"><div style="direction:ltr;text-align:left;color:#fff0bd;font-size:30px;font-weight:900;letter-spacing:.22em">LUXORA</div><div style="margin-top:6px;color:#a99769;font-size:11px;font-weight:900;letter-spacing:.18em;direction:ltr;text-align:left">PRIVATE ACCESS</div><div style="display:inline-block;margin-top:28px;border:1px solid rgba(255,240,189,.28);border-radius:999px;padding:9px 14px;color:#fff0bd;font-size:12px;font-weight:900;background:rgba(0,0,0,.28)">${esc(o.eyebrow || 'LUXORA NOTICE')}</div><h1 style="margin:22px 0 0;color:#fff0bd;font-size:34px;line-height:1.35;font-weight:900">${esc(o.title)}</h1></td></tr><tr><td style="padding:34px"><p style="margin:0;color:#d8c99d;font-size:17px;line-height:2.05">${esc(o.body).replace(/\n/g, '<br>')}</p>${code}${btn}<div style="margin-top:34px;padding:18px;border:1px solid rgba(255,255,255,.075);border-radius:22px;background:rgba(255,255,255,.035);color:#8f805f;font-size:12px;line-height:1.9">این پیام به صورت خودکار از Luxora ارسال شده است. اگر این فعالیت را شما انجام نداده‌اید، وارد حساب خود شوید و وضعیت امنیتی حساب را بررسی کنید.</div></td></tr></table><div style="margin-top:18px;color:#6f6246;font-size:12px;direction:ltr">Luxora · Private booking platform</div></td></tr></table></body></html>`
}
